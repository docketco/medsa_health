...
// Decompose any Date/ISO string/epoch-ms number into its Hong Kong
// wall-clock parts. Accepting a raw number matters in practice - several
// callers store a check-in/appointment time as `new Date(x).getTime()`
// (a plain number) rather than a Date or ISO string, and this used to
// crash with "d.getTime is not a function" the moment one of those
// numbers reached here directly.
