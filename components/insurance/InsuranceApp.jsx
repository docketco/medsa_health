      ...
      {displayMode==='roster'&&<>
        ...
        <Card style={{padding:'16px'}}>
          ...
          {addingOne&&<div style={{borderTop:`0.5px solid ${C.border}`,paddingTop:'14px'}}>
            ...
            <div style={{display:'flex',gap:'8px',marginBottom:'10px'}}>
              <input type="number" value={oneForm.copay_rate} onChange={e=>setOneForm(f=>({...f,copay_rate:e.target.value}))} placeholder="Copay %" style={{flex:1,minWidth:0,border:`0.5px solid ${C.border}`,borderRadius:'8px',padding:'8px 10px',fontSize:'12px',background:C.beige,outline:'none',fontFamily:'inherit',boxSizing:'border-box'}}/>
              <input type="number" value={oneForm.annual_deductible_hkd} onChange={e=>setOneForm(f=>({...f,annual_deductible_hkd:e.target.value}))} placeholder="Deductible HK$" style={{flex:1,minWidth:0,border:`0.5px solid ${C.border}`,borderRadius:'8px',padding:'8px 10px',fontSize:'12px',background:C.beige,outline:'none',fontFamily:'inherit',boxSizing:'border-box'}}/>
              <input type="number" value={oneForm.overall_annual_limit_hkd} onChange={e=>setOneForm(f=>({...f,overall_annual_limit_hkd:e.target.value}))} placeholder="Annual limit" style={{flex:1,minWidth:0,border:`0.5px solid ${C.border}`,borderRadius:'8px',padding:'8px 10px',fontSize:'12px',background:C.beige,outline:'none',fontFamily:'inherit',boxSizing:'border-box'}}/>
            </div>
            <div style={{display:'flex',gap:'8px'}}>
